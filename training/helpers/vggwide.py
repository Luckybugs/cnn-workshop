...
def VGG_WIDE(include_top=True, input_shape=(32,32,3), classes=10):
    ...
    if include_top:
        ...
        x = Dense(4096, activation='relu', kernel_regularizer=regularizers.l2(0.001), name='fc1')(x)
        x = BatchNormalization(axis=-1)(x)
        x = Dense(4096, activation='relu', kernel_regularizer=regularizers.l2(0.001), name='fc2')(x)
        x = BatchNormalization(axis=-1)(x)
